...
export class AppComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.extractLogos();
        this.form.get('dependancies').valueChanges.subscribe(() => this.extractLogos());
    }
    ...
    extractLogos() {
        ...
        this.techStack = [];
        let s = Object.keys(JSON.parse(this.form.get('dependancies').value).devDependencies).concat(
